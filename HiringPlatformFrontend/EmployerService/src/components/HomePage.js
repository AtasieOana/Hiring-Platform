...
const HomePage = () => {
    ...
    return (
        <div>
                                    ...
                                    {currentJobs.map(job => (
                                        <div className="job-item" key={job.id}>
                                            <div className="jobs-company-logo">
                                                {profilePhoto ?
                                                    <img className="job-profile-image" src={`data:image/jpeg;base64,${profilePhoto}`}
                                                         alt="Company Logo"/>
                                                    :
                                            ...
                                            <div className="job-details">
                                                <div className="jobs-detail-text">
                                                    <div className="jobs-detail">
                                                        <div className="job-text-date">{formatDate(job.postingDate)}</div>
                                                    </div>
                                                    <div className="jobs-detail">
                                                        <div className="job-text-title" onClick={()=>{viewJob(job)}}>{job.title}</div>
                                                    </div>
                                                    <div className="jobs-detail">
                                                        <Icon icon="route" className="icon"/>
                                                        <div className="job-text">{job.cityName}, {job.regionName}, {job.countryName}</div>
                                                    </div>
                                                    <div className="jobs-detail">
                                                        <Icon icon="application" className="icon"/>
                                                        <div className="job-text">{experiences[possibleExperiences.findIndex(i => i=== job.experience)]}</div>
                                                    </div>
                                                    <div className="jobs-detail">
                                                        <Icon icon="globe-network" className="icon"/>
                                                        <div className="job-text">{industries[industriesRo.findIndex(i => i=== job.industry)]}</div>
                                                    </div>
                                                </div>
                                                <Tooltip className="show-job-tooltip" content={t('see_more_about_job')} position="bottom-left">
                                                    <Button
            ...
            <AddJobDialog isDialogOpen={isDialogOpen} handleDialogAction={handleDialogAction} handleJobAddition={getJobs}/>
        </div>
    );
};
