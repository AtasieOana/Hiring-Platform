            ...
            <div className="contact-container">
                <div className="contact-container-left">
                    ...
                    <div className="contact-us-program">
                        ...
                        <div className="contact-us-program-hours">8:00 AM – 8:00 PM CET</div>
                        <div className="contact-us-program-hours">{t('program_s')}</div>
                        <div className="contact-us-program-hours">9:00 AM – 6:00 PM CET</div>
                    </div>
                </div>
                <div className="contact-container-right">
                    ...
                    <div className="contact-cards">
                        <Card className="contact-card" interactive={false} elevation={Elevation.TWO}>
                            <Icon className="contact-icon" icon="envelope" size={50}/>
                            <div>
                                {t('principal_contact')}
                            </div>
                            <div className="contact-imp">
                                <a href={"mailto:" + PRINCIPAL_ADMIN_EMAIL}>{PRINCIPAL_ADMIN_EMAIL}</a>
                            </div>
                        </Card>
                        <Card className="contact-card" interactive={false} elevation={Elevation.TWO}>
                    ...
                    <div className="additional-contacts">
                        <div className="contact-title-additional">{t('additional_contacts')}</div>
