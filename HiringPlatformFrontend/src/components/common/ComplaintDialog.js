...
import { AppToasterTop } from "./AppToaster";
    ...
    >
      <div className={Classes.DIALOG_BODY}>
        <div className="complaint-description">
          {t("complaint_desc")}{" "}
          <span className="complaint-description-bold">{complainedUser}</span>{" "}
          {t("complaint_desc1")}
        </div>
        <FormGroup
      ...
      <div className={Classes.DIALOG_FOOTER}>
        <div className={Classes.DIALOG_FOOTER_ACTIONS}>
          <Button
            ...
            onClick={validateComplaint}
          >
            {t("submit")}
          </Button>
          <Button onClick={onClose} className={"user-button-for-outline"}>
            {t("cancel")}
          </Button>
        </div>
      </div>
