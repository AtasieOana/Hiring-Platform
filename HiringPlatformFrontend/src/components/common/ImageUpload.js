...
const ImageUpload = ({onImageUpload, initialImg}) => {
    ...
    return (
        <div className="custom-file-container">
            <div className="custom-image-container">
                {selectedImage && (
                    <div className="custom-image-wrapper">
                        <img className="custom-image" src={URL.createObjectURL(selectedImage)} alt="Profile image"/>
            ...
            <div className={selectedImage ? "file-input-container" : "file-input-container-hole"}>
                <div className="file-input-label-title">
                    {t('choose_img')}
                </div>
