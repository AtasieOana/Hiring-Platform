...
const JobView = () => {
  ...
  const allExperiences =
    i18n.language === "ro" ? experiencesRo : experiencesEng;
  ...
  const getApplicationForCandidate = () => {
    AppService.checkApplication(candidate.candidateId, openedJob.jobId)
      .then((response) => {
      ...
      >
        <DialogBody useOverflowScrollContainer={false}>
          ...
          <DialogFooter
            ...
            actions={
              <div>
                <Button intent="danger" onClick={closeJob}>
                  {t("close")}
                </Button>
  ...
  const CVItem = ({ cv }) => {
    return (
      <div className="cv-item">
        ...
        />
        <Button intent={Intent.PRIMARY} small onClick={() => handleOpenCV(cv)}>
          {t("view_cv")}
        </Button>
      </div>
    );
  ...
  const renderChooseCVDialog = () => {
    return (
      ...
      >
        <DialogBody useOverflowScrollContainer={false}>
          <FormGroup label={t("choose_a_cv_ex")}>
  ...
  const renderQuestionDialog = () => {
    return (
      ...
      >
        <DialogBody useOverflowScrollContainer={false}>
          <FormGroup label={t("answer_questions_ex")}>
            <div className="cv-choose-div">
              {questionWithAnswers.map((qa, index) => (
                <>
                  <FormGroup
                    intent={
                      qa.answer.length < 10 || qa.answer.length >= 4000
                        ? "danger"
                        : "none"
                    }
                    helperText={
            ...
            actions={
              <div>
                <Button
                  ...
                  disabled={
                    questionWithAnswers.filter(
                      (qa) => qa.answer.length < 10 || qa.answer.length >= 4000,
                    ).length > 0
                  }
                >
                  {t("submit")}
  ...
  const addAnswersForQuestions = () => {
    ...
    AppService.addAnswersForQuestions(qRequest)
      .then((response) => {
        addApplication();
      })
      .catch((error) => {
  ...
  const addApplication = () => {
    ...
    AppService.applyToJob(qRequest)
      .then((response) => {
        setApplied(true);
        setAnswersDialog(false);
        setChooseCVDialog(false);
    ...
    <div>
      ...
      <div className="show-job-details-page">
            ...
            <Card className="show-job-profile-card">
              <div className="show-job-profile-info">
                ...
                openedJob.employerProfile.imagine ? (
                  <img
                    className="show-job-profile-image"
                  ...
                  <img
                    className="show-job-profile-image"
                    src={`data:image/jpeg;base64,${profileInfo.imagine}`}
                    alt="Company Logo"
                  />
                ) : (
                  <img
                ...
                <h2 className="show-job-profile-name">
                  {usedEmployer.companyName}
                </h2>
                <p>
                  {t("email_simple")}:{" "}
                  <span className="show-job-profile-span">
                    {usedEmployer.userDetails.email}
                  </span>
                </p>
                <Button
              ...
              <div className="show-job-info">
                ...
                <p>
                  ...
                  <span className="show-job-profile-span">
                    ...
                    {
                      allContracts[
                        possibleContractType.findIndex(
                          (i) => i === openedJob.contractType,
                        )
                      ]
                    }
                  </span>
                ...
                <p>
                  ...
                  <span className="show-job-profile-span">
                    ...
                    {
                      allRegimes[
                        possibleRegimeEmp.findIndex(
                          (i) => i === openedJob.employmentRegime,
                        )
                      ]
                    }
                  </span>
                ...
                <p>
                  ...
                  <span className="show-job-profile-span">
                    ...
                    {
                      allIndustries[
                        industriesRo.findIndex((i) => i === openedJob.industry)
                      ]
                    }
                  </span>
                </p>
                <p>
                  ...
                  <span className="show-job-profile-span">
                    ...
                    {
                      allWorks[
                        possibleWorkMode.findIndex(
                          (i) => i === openedJob.workMode,
                        )
                      ]
                    }
                  </span>
                ...
                <p>
                  ...
                  <span className="show-job-profile-span">
                    {" "}
                    {formatDate(openedJob.postingDate)}
                  </span>
                </p>
                <p>
                  {t("city")}:
                  <span className="show-job-profile-span">
                    {" "}
                    {openedJob.cityName}, {openedJob.regionName}
                  </span>
                </p>
              </div>
            </Card>
          ...
          <div className="show-job-details">
            <div className="show-job-actions">
              <Button
                ...
                className="view-candidates-for-job"
              />
              {employer &&
                employer.employerId !== "" &&
                openedJob.status === OPENED && (
                  <Button
            ...
            <div className="show-job-container">
              ...
              <div className="show-job-edit-desc-container">
                {employer && employer.employerId !== "" && !isEditDesc ? (
                  <Button
                    className="show-job-edit-desc"
                    text={t("edit_job_desc")}
                    icon="style"
        ...
        <Card className="show-stages-section">
          <div className="show-job-title-section">
            {" "}
            <Icon icon="path-search" color="black" /> {t("stages")}{" "}
          </div>
        ...
        {employer &&
          ...
          openedJob.questions.length > 0 && (
            <Card className="show-questions-section">
              <div className="show-job-title-section">
                {" "}
                <Icon icon="help" color="black" /> {t("questions")}{" "}
              </div>
              <ul className="show-job-list-section">
