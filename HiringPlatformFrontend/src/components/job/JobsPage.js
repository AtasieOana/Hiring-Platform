            ...
            <div className={"jobs-component"}>
                ...
                <div className={"right-section"}>
                    <div className={"job-page-buttons"}>
                        {employer && employer.employerId !== "" && <Button className="add-job-button"
                        ...
                        <div className="job-page-second-line-buttons">
                            <InputGroup
                                disabled={false}
                                placeholder={candidate && candidate.candidateId !== "" ? t('search_by_title_or_company') : t('search_by_title')}
                                type="search"
                                    ...
                                    {currentJobs.map(job => (
                                        <div className="job-item" key={job.id}>
                                            <div className="jobs-company-logo">
                                                {candidate && candidate.candidateId !=='' && job.employerProfile.imagine ?
                                                    <img className="job-profile-image"
                                                         src={`data:image/jpeg;base64,${job.employerProfile.imagine}`}
                                                         alt="Company Logo"/>
                                                    : employer && employer.employerId !=='' && profilePhoto ?
                                                    <img className="job-profile-image" src={`data:image/jpeg;base64,${profilePhoto}`} alt="Company Logo"/>
                                                        :
