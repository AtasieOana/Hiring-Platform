...
const CandidateApplicationViewChart = (candidateId) => {
    ...
    const fetchData = () => {
        CandidateService.getApplicationViewedNumbers(candidateId.candidateId).then((response) => {
    ...
    return (
        <div className="profile-chart-container">
            <div className="profile-chart-title">{t('number_of_app_view_candidates')}</div>
