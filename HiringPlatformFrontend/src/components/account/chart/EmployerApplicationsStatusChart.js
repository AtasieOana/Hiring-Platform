...
const EmployerApplicationStatusChart = (employerId) => {
    ...
    const fetchData = () => {
        EmployerService.getAppsStatusNumbers(employerId.employerId).then((response) => {
    ...
    return (
        <div className="profile-chart-container">
            <div className="profile-chart-title">{t('number_of_app_status_employers')}</div>
...
export default EmployerApplicationStatusChart;
