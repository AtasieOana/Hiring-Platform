...
import {
    ...
    Classes, Dialog, DialogBody, DialogFooter, Drawer, FileInput,
    FormGroup, H3, H5,
    Icon,
    InputGroup,
    Intent, MenuItem,
...
import {possibleDates} from "../HomePage";
...
const ApplicationPage = () => {
    ...
    const handleFilterReset = () => {
        let companyResponse = [...new Set(apps.map(j => j.employerCompanyName))];
        setFilters({
            status: possibleStatus,
